        ...
        <View style={styles.container} onLayout={this.onContainerLayout}>
          ...
          <View style={styles.main}>
            <View style={styles.stickyHeader}>
              <MainHeader toggleDrawer={toggleDrawer} sidebarVisibility={sidebarVisibility} />
              {/* <MainFilter /> */}
            </View>
